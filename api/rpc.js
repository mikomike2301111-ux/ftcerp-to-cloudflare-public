...
async function taxInvoicePdfBuffer({ invoice, items, customer, settings, options = {} }) {
  ...
  const configuredLogoUrl = clean(settings.invoice_logo_url || settings.company_logo_url || settings.company_qr_url || 'https://i.postimg.cc/MZsvCfTp/FTC-LOGO2.png');
...
const FARMTRACK_LOGO_URL = 'https://i.postimg.cc/MZsvCfTp/FTC-LOGO2.png';
...
function ensureFarmtrackCatalogue(state) {
  ...
  if (!state.settings.invoice_logo_url || !String(state.settings.invoice_logo_url).includes('FTC-LOGO')) {
  ...
  if (!state.settings.company_name) {
    state.settings.company_name = 'Farmtrack Bio Sciences Ltd';
    changed = true;
  }
...
function seed() {
  ...
  db = {
    ...
    settings: {
      company_name: 'Farmtrack Bio Sciences Ltd',
      ...
      invoice_logo_url: 'https://i.postimg.cc/MZsvCfTp/FTC-LOGO2.png',
      company_logo_url: 'https://i.postimg.cc/MZsvCfTp/FTC-LOGO2.png',
      company_qr_url: 'https://i.postimg.cc/MZsvCfTp/FTC-LOGO2.png',
